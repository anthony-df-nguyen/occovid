    ...
    <div>
      ...
      <Page title="Case Detail">
        <div className="widgetGrid">
          <Widget title={"Total Cases (PCR)"} stat={lastTotalCases} color={color.gold} />
          <Widget title={"Daily PCR Reported"} stat={lastDailyReported} color={color.red} />
          <Widget title={"Recovered"} stat={lastRecovered} color={color.blue} />
          <Widget title={"Homeless Cases"} stat={lastHomeless} color={color.purple} />
        ...
        <div id="chartGrid">
          ...
          <Chart
            ...
            label={["Cases"]}
          />
          <Chart key="6" id="case6" switches={["bar", "line"]} date={array.map((a) => a.date)} data={[array.map((b) => b.jailCases)]} fill={[color.yellow]} title={"Jail Cases"} label={["Cases"]} />
        </div>
      </Page>
    </div>
  );
